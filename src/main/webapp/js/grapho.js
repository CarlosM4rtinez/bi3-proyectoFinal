...
function mouseoverHandler(d) {
    var msj = "";
    // Validamos si es informacion de un link o de un nodo
    if(d.conector == null){
        // nodo
        msj = d.atributo+" "+d.compara+" "+d.valor;
    }else{
        // link
        msj = d.conector;
    }
    document.getElementById("tooltip").innerHTML = msj;
    document.getElementById("tooltip").style.opacity = 1;
}
// ubica el tooltip en el puntero
